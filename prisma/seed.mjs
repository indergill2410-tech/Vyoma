...
const reviews = [
  ...
  },
  {
    ...
    author: "Hannah M.",
    rating: 5,
    title: "Worth the made-to-order wait",
    body: "Took about ten days and arrived in the most beautiful packaging. Feels premium, fits like it was made for me — because it kind of was.",
    verified: true,
    status: "approved",
  },
  {
