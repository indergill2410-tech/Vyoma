...
export const BRAND = {
  ...
  description:
    "Premium natural-fibre activewear for the studio, the gym and everyday life. Natural fibre first, fewer synthetics against your skin. Vyoma (vee-OH-ma): Sanskrit for sky, ether, infinite space.",
};
