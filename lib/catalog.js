...
export const PRODUCTS = [
  ...
  {
    slug: "vyoma-mens-cotton-training-tee",
    name: "The Cotton Training Tee",
    tagline: "Cotton-rich gym polish.",
    category: "Tops",
    audience: "men",
    photoModel: "male",
    photoExt: "png",
    hero: true,
    priceAud: 6400, // A$64
    priceInr: 195000, // ₹1,950
    description:
      "A fitted cotton-rich training tee with clean shoulder shaping, breathable structure and a premium gym finish. Built for lifting, warm-ups and the sharp walk out after training.",
    fabric: "Organic cotton-modal interlock with natural recovery and a smooth cool hand.",
    care: "Cold wash inside out, line dry. Steam lightly to reset the shape.",
    fit: "Athletic fit through the chest and arms, straight through the body. Size up for a looser gym fit.",
    colourways: ["peacock-teal", "saffron-sun", "night-sky-indigo", "ether"],
    sizes: ["S", "M", "L", "XL", "XXL"],
    leadTime: "Made to order · ships in 7–14 days",
  },
  {
    slug: "vyoma-mens-lift-muscle-tank",
    name: "The Lift Muscle Tank",
    tagline: "Open arm, clean cotton.",
    category: "Tops",
    audience: "men",
    photoModel: "male",
    photoExt: "png",
    ...
    priceInr: 170000, // ₹1,700
    description:
      "A premium cotton rib muscle tank cut with room through the armhole and enough structure to stay sharp through presses, pull days and hot studio sessions.",
    fabric: "Organic cotton rib with a soft stretch feel and reinforced neck binding.",
    care: "Cold wash, line dry. Wash with similar colours to keep the rib rich.",
    fit: "Athletic tank fit with a clean shoulder line. Take your usual size.",
    colourways: ["lotus-coral", "clear-sky-blue", "monsoon-grey", "night-sky-indigo"],
    sizes: ["S", "M", "L", "XL", "XXL"],
    leadTime: "Made to order · ships in 7–14 days",
  },
  {
    slug: "vyoma-mens-heavy-pump-tee",
    name: "The Heavy Pump Tee",
    tagline: "Oversized cotton weight.",
    category: "Tops",
    audience: "men",
    photoModel: "male",
    photoExt: "png",
    hero: true,
    priceAud: 7400, // A$74
    priceInr: 225000, // ₹2,250
    description:
      "A heavyweight cotton gym tee with an oversized frame, dropped shoulder and premium drape. Made for pump covers, travel days and relaxed recovery wear.",
    fabric: "Heavy organic cotton jersey with a compact knit, soft face and structured fall.",
    care: "Cold wash inside out, line dry. Avoid tumble drying to protect the heavyweight shape.",
    fit: "Oversized through the body with a strong shoulder. Size down for a regular tee fit.",
    colourways: ["mango-pop", "clear-sky-blue", "monsoon-grey", "night-sky-indigo"],
    sizes: ["S", "M", "L", "XL", "XXL"],
    leadTime: "Made to order · ships in 7–14 days",
  },
  {
    slug: "vyoma-mens-7-inch-training-short",
    name: "The 7-Inch Training Short",
    tagline: "Cotton gym short, premium line.",
    category: "Bottoms",
    audience: "men",
    photoModel: "male",
    photoExt: "png",
    ...
    priceInr: 230000, // ₹2,300
    description:
      "A structured 7-inch gym short with a clean front, secure waistband and cotton-rich stretch for squats, machines, mat work and warm-weather days.",
    fabric: "Organic cotton performance twill with natural stretch, soft pocketing and a smooth internal drawcord.",
    care: "Cold wash, line dry. Wash dark colours separately.",
    fit: "Athletic regular fit with a 7-inch inseam. Size up if you prefer more room in the thigh.",
    colourways: ["night-sky-indigo", "peacock-teal", "ether", "saffron-sun"],
    sizes: ["S", "M", "L", "XL", "XXL"],
    leadTime: "Made to order · ships in 7–14 days",
  },
  {
    slug: "vyoma-mens-cotton-flex-track-pant",
    name: "The Cotton Flex Track Pant",
    tagline: "Track clean, cotton soft.",
    category: "Bottoms",
    audience: "men",
    photoModel: "male",
    photoExt: "png",
    hero: false,
    priceAud: 9800, // A$98
    priceInr: 315000, // ₹3,150
    description:
      "A premium cotton track pant with a straight-tapered leg, hidden zip pockets and enough give for training days that turn into full days out.",
    fabric: "Cotton-rich double-knit with a smooth face, soft inner and natural movement.",
    care: "Cold wash inside out, line dry flat for the cleanest line.",
    fit: "Straight-tapered athletic fit. Take your usual size for a sharp track silhouette.",
    colourways: ["monsoon-grey", "night-sky-indigo", "peacock-teal", "ether"],
    sizes: ["S", "M", "L", "XL", "XXL"],
    leadTime: "Made to order · ships in 10–16 days",
  },
  {
    slug: "vyoma-mens-studio-performance-jogger",
    name: "The Studio Performance Jogger",
    tagline: "Sharper jogger, gym ready.",
    category: "Bottoms",
    audience: "men",
    photoModel: "male",
    photoExt: "png",
    hero: false,
    priceAud: 10200, // A$102
    priceInr: 330000, // ₹3,300
    description:
      "An upgraded cotton-rich jogger with a sculpted taper, premium cuff, secure pockets and a cleaner gym-to-street shape than a standard sweatpant.",
    fabric: "Organic cotton fleece blended for soft structure, brushed inside with ribbed waistband and cuffs.",
    care: "Cold wash inside out, line dry. Brush lightly after drying to refresh the fleece.",
    fit: "Relaxed through the thigh, close below the knee. Size down for a leaner studio line.",
    colourways: ["night-sky-indigo", "dawn-rose", "monsoon-grey", "parrot-green"],
    sizes: ["S", "M", "L", "XL", "XXL"],
    leadTime: "Made to order · ships in 10–16 days",
  },
  {
    slug: "vyoma-mens-warmup-zip-hoodie",
    name: "The Warmup Zip Hoodie",
    tagline: "Premium fleece before training.",
    category: "Layers",
    audience: "men",
    photoModel: "male",
    photoExt: "png",
    hero: true,
    priceAud: 11800, // A$118
    priceInr: 380000, // ₹3,800
    description:
      "A cotton fleece zip hoodie with a clean athletic frame, premium metal zip and soft warmth for early sessions, cool-downs and travel days.",
    fabric: "Organic cotton fleece with brushed inner face, rib cuffs, premium zip and reinforced hood edge.",
    care: "Cold wash zipped and inside out, line dry. Do not tumble dry the zip tape.",
    fit: "Regular athletic layer with room over a tee. Size up for a heavier warmup fit.",
    colourways: ["ether", "night-sky-indigo", "saffron-sun", "peacock-teal"],
    sizes: ["S", "M", "L", "XL", "XXL"],
    leadTime: "Made to order · ships in 10–16 days",
  },
  {
    slug: "vyoma-mens-recovery-crew-sweatshirt",
    name: "The Recovery Crew Sweatshirt",
    tagline: "Soft cotton after the work.",
    category: "Layers",
    audience: "men",
    photoModel: "male",
    photoExt: "png",
    ...
    priceInr: 320000, // ₹3,200
    description:
      "A premium cotton recovery crew with a relaxed athletic shape, soft brushed inside and joyful colour that still feels grown-up.",
    fabric: "Organic cotton fleece with rib collar, cuffs and hem for a clean premium hold.",
    care: "Cold wash inside out, line dry. Store folded to protect the shoulder shape.",
    fit: "Relaxed athletic crew. Size down for a closer layer, size up for lounge volume.",
    colourways: ["clear-sky-blue", "lotus-coral", "night-sky-indigo", "ether"],
    sizes: ["S", "M", "L", "XL", "XXL"],
    leadTime: "Made to order · ships in 10–16 days",
  },
  {
