...
export function productShots(product) {
  ...
  return [
    { slot: "model", src: `${base}/model.webp`, alt: `${product.name}, worn` },
    { slot: "back", src: `${base}/back.webp`, alt: `${product.name}, back view` },
    { slot: "detail", src: `${base}/detail.webp`, alt: `${product.name}, fabric detail` },
  ];
}
