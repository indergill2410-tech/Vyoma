...
export const PRODUCTS = [
  ...
  },
  {
    ...
    shots: {
      model: "/products/vyoma-practice-tee/men-lifestyle.png",
      back: "/products/vyoma-practice-tee/men-lifestyle.png",
      detail: "/products/vyoma-practice-tee/men-lifestyle.png",
    },
    hero: false,
    priceAud: 5600, // A$56
  ...
  },
  {
    ...
    tagline: "The saffron kit bag.",
    category: "Accessories",
    audience: "unisex",
    catalogues: ["men"],
    mensGroup: "Carry + Socks",
    shots: {
      model: "/products/vyoma-mat-bag/men-lifestyle.png",
      back: "/products/vyoma-mat-bag/men-lifestyle.png",
      detail: "/products/vyoma-mat-bag/men-lifestyle.png",
    },
    hero: false,
    priceAud: 3900, // A$39
  ...
  },
  {
    ...
    tagline: "Gym-to-street taper.",
    category: "Bottoms",
    audience: "unisex",
    catalogues: ["men"],
    mensGroup: "Training + Transit",
    shots: {
      model: "/products/vyoma-jogger/men-lifestyle.png",
      back: "/products/vyoma-jogger/men-lifestyle.png",
      detail: "/products/vyoma-jogger/men-lifestyle.png",
    },
    hero: false,
    priceAud: 8900, // A$89
    priceInr: 290000, // ₹2,900
  ...
  },
  {
    ...
    tagline: "Heavy fleece, street finish.",
    category: "Layers",
    audience: "unisex",
    catalogues: ["men"],
    mensGroup: "Recovery",
    shots: {
      model: "/products/vyoma-meditation-hoodie/men-lifestyle.png",
      back: "/products/vyoma-meditation-hoodie/men-lifestyle.png",
      detail: "/products/vyoma-meditation-hoodie/men-lifestyle.png",
    },
    hero: false,
    priceAud: 9900, // A$99
  ...
  },
  {
    ...
    shots: {
      model: "/products/vyoma-pure-trunk-men/men-lifestyle.png",
      back: "/products/vyoma-pure-trunk-men/men-lifestyle.png",
      detail: "/products/vyoma-pure-trunk-men/men-lifestyle.png",
    },
    hero: false,
    priceAud: 2700, // A$27
    priceInr: 85000, // ₹850
  ...
  },
  {
    ...
    mensGroup: "Carry + Socks",
    shots: {
      model: "/products/vyoma-organic-crew-sock/men-lifestyle.png",
      back: "/products/vyoma-organic-crew-sock/men-lifestyle.png",
      detail: "/products/vyoma-organic-crew-sock/men-lifestyle.png",
    },
    hero: false,
    priceAud: 1900, // A$19
    priceInr: 60000, // ₹600
...
export function productShots(product) {
  ...
  const makeShot = (slot, alt) => ({
    slot,
    src: configured[slot] || `${base}/${slot}.webp`,
    fallbackSrc: configured[slot] ? undefined : `${base}/${slot}.png`,
    alt,
  });
