...
export const PRODUCTS = [
  {
    ...
    fabric: "Recycled four-way-stretch knit. Soft on skin.",
  ...
  },
  {
    ...
    fabric: "Both pieces. One feeling. Soft on skin.",
  ...
  },
  {
    ...
    fabric: "Natural cotton with a soft, brushed inside.",
  ...
  },
  {
    ...
    fabric: "Recycled stretch knit with a soft brushed band.",
  ...
  },
  {
    ...
    fabric: "Recycled four-way-stretch knit, supportive band.",
    care: "Cold wash, line dry. Remove pads before washing.",
  ...
  },
  {
    ...
    fabric: "Natural cotton fleece with a brushed inside.",
  ...
  },
  {
    ...
    priceInr: 80000, // ₹800
    description:
      "The layer closest to you, made clean. Soft, breathable natural cotton with a gentle waistband — designed without the plastics and harsh finishes of synthetic underwear.",
    fabric: "Natural cotton, soft and breathable.",
  ...
  },
  {
    ...
    priceInr: 85000, // ₹850
    description:
      "Breathable, all-day comfort. Natural cotton with nothing synthetic where it counts — the everyday layer, made clean.",
    fabric: "Natural cotton, breathable and soft.",
    care: "Cold wash, line dry.",
...
export function productShots(product) {
  ...
  return [
    ...
    { slot: "back", src: `${base}/back.png`, alt: `${product.name}, back view` },
