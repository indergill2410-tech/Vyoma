...
export const TIERS = [
  { at: 0, key: "joined", label: "On the list", perk: "First to hear the moment the drop opens." },
  { at: 1, key: "early", label: "Early access", perk: "Shop the first drop before it opens to everyone." },
  ...
  { at: 10, key: "piece", label: "A piece on us", perk: "A piece from the first drop, our gift to you." },
];
