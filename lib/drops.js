// The drops calendar. Small runs, announced to the list first. Status is
// explicit (not date-derived) so badges never go stale. Honest for a
// pre-launch brand: one upcoming drop, the rest on the horizon.
export const DROPS = [
  {
    key: "first-light",
    name: "First Light",
    edition: "Drop 001 · The first drop",
    when: "Launching soon",
    status: "upcoming",
    blurb:
  ...
  },
  {
    ...
    when: "On the horizon",
    status: "planned",
    blurb: "A warm capsule for long evenings — marigold, front and centre.",
